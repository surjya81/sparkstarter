...
public final class JavaLogQuery {
	...
	/**
	 * Tracks the total query count and number of aggregate bytes for a particular
	 * group.
	 */
	...
	public static void main(String[] args) {
		SparkSession spark = SparkSession.builder().appName("JavaLogQuery").master("local[2]").getOrCreate();
		...
		JavaPairRDD<Tuple3<String, String, String>, Stats> extracted = dataSet
				.mapToPair(s -> new Tuple2<>(extractKey(s), extractStats(s)));
